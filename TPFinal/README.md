# RuloPlast tienda OnLine

Mi primer proyecto en base a un ecommerce. Ésta app puede darnos los diferentes envases a comprar mediante listas y categorías, realizar compras de estos mismos, todo en modo On line. La base de dato que utilizamos es Firebase, alli almacenamos todos nuestros datos con los que trabajar.
...
## Funcionalidades
- Ver una lista de envases disponibles
- Agregar envases al carrito de compras
